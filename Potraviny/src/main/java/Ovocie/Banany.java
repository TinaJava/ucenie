 ...
 * @author vlada
 */
public class Banany extends Ovocie_Zelenina {
    private Farba farba;

    public Banany(Farba farba, String nazov, double hmotnost, int cena, boolean sladke, boolean supka, boolean kysele) {
