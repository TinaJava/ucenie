 ...
 * @author vlada
 */
public class Kapusta extends Ovocie_Zelenina {

    private Farba farba;

    public Kapusta(Farba farba, String nazov, double hmotnost, int cena, boolean sladke, boolean supka, boolean kysele) {
